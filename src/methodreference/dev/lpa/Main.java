package methodreference.dev.lpa;
...
//        list.forEach(s -> System.out.println(s));
        ...
        calculator(Double::sum, 10.3, 25.4);
        System.out.println("------------------");
//        Supplier<PlainOld> reference1 = () -> new PlainOld();
        ...
        calculator((s1, s2) -> s1 + s2, "Hello ", "Worlds");
//        calculator((s1, s2) -> s1.concat(s2), "Hello ", "Worlds");
        calculator(String::concat, "Hello ", "Worlds");
