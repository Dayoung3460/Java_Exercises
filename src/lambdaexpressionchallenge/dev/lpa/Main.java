package lambdaexpressionchallenge.dev.lpa;
...
public class Main {
    ...
    public static void main(String[] args) {
        String[] names = {"Anna", "Bob", "Carole", "David", "Ed", "Fred", "Gray"};
        ...
        System.out.println(newList.get(0).substring(0, newList.get(0).indexOf(" ")));
        System.out.println(newList.get(0).substring(newList.get(0).lastIndexOf(" ") + 1));
