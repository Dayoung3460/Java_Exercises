...
public class AdventureGame {
    ...
    public void loadLocations(String data) {
        for (String s : data.split("\\R")) {
            // split의 limit 인자:
            // limit 이 0보다 클 경우: limit 개수만틈 요소를 split함
            // limit == 0: 맨 뒤 값이 빈값이면 생갹 - default
            //limit < 0: 맨 뒤 빈값에 대해 split 모두 진행
